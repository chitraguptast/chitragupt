    ...
    return (
      <div className="relative w-full" ref={dropdownRef}>
        ...
        >
          ...
          <ChevronDownIcon
            className={`w-5 h-5 ml-2 text-gray-400 flex-shrink-0 transition-transform duration-200 ${
        ...
        {isOpen && (
          <div
            className="absolute z-10 mt-1 w-full bg-white shadow-lg rounded-md py-1 text-base ring-1 ring-black ring-opacity-5 focus:outline-none sm:text-sm animate-fade-in-down max-h-60 overflow-auto"
            role="listbox"
          >
            {options.map((option) => (
              <div
